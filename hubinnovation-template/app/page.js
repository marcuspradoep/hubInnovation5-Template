      ...
      <div className="w-80 bg-slate-600 p-6 rounded-lg shadow-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="form-control">
            ...
            <input onChange={(e)=>setUsuario(e.target.value)} type="text" placeholder="Digite o usuario" className="w-full px-3 py-2 rounded-lg"></input>
          </div>
          <div className="form-control">
            <label className="block text-white">Senha</label>
            <input onChange={(e)=>setSenha(e.target.value)} type="password" placeholder="Digite a senha" className="w-full px-3 py-2 rounded-lg"></input>
          </div>
